...
export default function ProdutosPage() {
  ...
  const productsData = [
    {
      id: "1",      name: "Kit Cristais de Proteção",      price: "R$ 120,00",      imageSrc: "http://img.b2bpic.net/free-photo/view-hand-rocks-arrangement_23-2149324173.jpg?_wi=2",      imageAlt: "Kit de cristais de proteção", variant: "Standard"},
    {
      id: "2",      name: "Tarot Marselha Clássico",      price: "R$ 95,00",      imageSrc: "http://img.b2bpic.net/free-photo/high-angle-woman-reading-tarot_23-2150273168.jpg?_wi=2",      imageAlt: "Tarot de Marselha", variant: "Standard"},
    {
      id: "3",      name: "Incensos Naturais Artesanais",      price: "R$ 45,00",      imageSrc: "http://img.b2bpic.net/free-photo/incense-sticks-stones-table_23-2149021422.jpg?_wi=1",      imageAlt: "Incensos artesanais", variant: "Standard"},
    {
      id: "4",      name: "Amuleto da Prosperidade",      price: "R$ 70,00",      imageSrc: "http://img.b2bpic.net/free-photo/beautiful-gemstones-jewelry_23-2149021385.jpg?_wi=1",      imageAlt: "Amuleto de prosperidade", variant: "Standard"},
    {
